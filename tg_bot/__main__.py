...
Visit [website](https://marketingtele.com/) to get information on all the latest updates.
"""
...
""".format(dispatcher.bot.first_name, "" if not ALLOW_EXCL else "If you have any bugs or questions on how to use me, have a look at my [Website]](https://marketingtele.com/).")
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Hello all Join https://marketingtele.com/")
